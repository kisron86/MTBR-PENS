...
void StereoFunction::stereoCalibration(StereoGrab* grabb){
	...
	int  nx=6, ny=4, frame = 0, n_boards =30, N;
...
void StereoFunction::stereoSavePointCloud()
{
	...
	double vk[9]= {2.167742, 3.619398,4.710200,5.404826, 6.203077, 6.531579, 7.148936, 7.411765, 7.875000};
	double jk[9]= {50, 100, 150, 200, 250, 300, 350, 400,450};
	double j1=0, j2=0;
	double v1=0, v2=0;
	double jarak;
