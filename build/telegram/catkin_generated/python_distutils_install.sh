...
echo_and_run cd "/home/kisron/catkin_workspace/src/telegram"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/kisron/catkin_workspace/src/telegram/setup.py" \
    build --build-base "/home/kisron/catkin_workspace/build/telegram" \
    install \
    $DESTDIR_ARG \
